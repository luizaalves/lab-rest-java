...
// Retornando o c´odigo HTTP 201 com a URL do recurso criado no campo Location
// do cabe¸calho HTTP
    ...
    public Response removePessoa(@PathParam("pessoa") String nome) {
        if (nome.equalsIgnoreCase("Fulano")) {
            return Response.ok("Pessoa exclu´ıda").build();
        }
